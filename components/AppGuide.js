...
function AppGuideScreen() {
    ...
    return (
        <View style={styles.container}>
            <TouchableOpacity 
                style={styles.option} 
                onPress={() => navigation.navigate('ApplicationGuideline')} // Navigate to ApplicationGuideline page
            >
            ...
            <TouchableOpacity 
                style={styles.option} 
                onPress={() => navigation.navigate('SecurityFeature')} // Navigate to SecurityFeature page
            >
